...
//               renderHead={(item, i) => <th key={i}>{item}</th>}
//               bodyData={topCustomers}
//               renderBody={(item, i) => (
//                 <tr key={i}>
//                   <td>{item.user}</td>
...
//             <Link to="/CustomerAnalysis" className="text-blue-600 hover:underline">
//               View all
//             </Link>
//           </div>
//         </div>
...
//           </div>
//           <div className="mt-4 text-right">
//             <Link to="/orderAnalysis" className="text-blue-600 hover:underline">
//               View all
//             </Link>
//           </div>
//         </div>
